...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Giddy Web web application."
  #
  #
  ...
  #
  # settings.secret_key_base= o_cubdOx1_I_98vcQ3-PwOGvoVnDCRLMTlLI1T29fOo
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("giddy-web.log", "w"))
  #
  #
end
